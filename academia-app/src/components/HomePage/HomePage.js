...
const SearchContainer = styled.div`
  ...
  transition: width 0.3s ease; margin: 0 auto; width: auto; max-width: 350px;
`;
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (articlesSectionRef.current) {
        ...
        let newHeroOpacity = 1 - (scrollY / (articlesSectionTop - windowHeight * 0.2));
    ...
    return (
        <>
            ...
            <Container>
                <HeroSection hide={hideHero} opacity={heroOpacity}>
